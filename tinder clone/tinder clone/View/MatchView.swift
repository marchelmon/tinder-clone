...
class MatchView: UIView {
    ...
    private let descriptionLabel: UILabel = {
        ...
        label.text = "You and ass man are a perfect match"
        return label
    } ()
    ...
    func configureAnimations() {
        ...
        UIView.animate(withDuration: 0.7, delay: 0.6 * 1.3, usingSpringWithDamping: 0.5, initialSpringVelocity: 0.1, options: .curveEaseOut, animations: {
